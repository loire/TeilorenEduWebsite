...
const translations = {
    en: {
        ...
        'university-teaching-description': 'Teaching Assistant (2006-2009, Sorbonne) delivering tutorials in mathematics and computer science.<br><br>Guest Lecturer in Epidemiology at Kasetsart University (2019-2022, Bangkok) for international students.<br><br>Trainer in genetic data analysis for international partners.',
        'research-title': 'Research Scientist (2009-2025)',
        'research-description': 'Research Scientist at CIRAD (2015-2025) leading projects on microbial genomics, evolutionary biology, and antimicrobial resistance.<br><br>Postdoctoral Researcher at CNRS and Max Planck Institute (2009-2015).<br><br>Author of 60 publications, cited 2500+ times.',
        'tutoring-title': 'Secondary Education & Tutoring',
        'tutoring-description': 'Private tutor for AP Biology at British International School of Hanoi (2025).<br><br>School outreach presenter (2013-2019) conducting engaging science sessions at French high schools and middle schools.',
        ...
        'publications-description': '60 publications and conference proceedings.<br><br>View my full publication list on <a href="https://scholar.google.com/citations?user=rxk_H-oAAAAJ" target="_blank" rel="noopener noreferrer">Google Scholar</a> or <a href="https://www.researchgate.net/profile/Etienne-Loire" target="_blank" rel="noopener noreferrer">ResearchGate</a>.',
    ...
    fr: {
        ...
        'university-teaching-description': 'Chargé de TD (2006-2009, Sorbonne) en mathématiques et informatique.<br><br>Professeur invité en Épidémiologie à l\'Université Kasetsart (2019-2022, Bangkok) pour étudiants internationaux.<br><br>Formateur en analyse de données génétiques pour partenaires internationaux.',
        'research-title': 'Chercheur Scientifique (2009-2025)',
        'research-description': 'Chercheur au CIRAD (2015-2025) dirigeant des projets sur la génomique microbienne, biologie évolutive et résistance antimicrobienne.<br><br>Chercheur postdoctoral au CNRS et Institut Max Planck (2009-2015).<br><br>Auteur de 60 publications, citées 2500+ fois.',
        'tutoring-title': 'Enseignement Secondaire & Tutorat',
        'tutoring-description': 'Tuteur privé en AP Biology à la British International School of Hanoi (2025).<br><br>Présentateur d\'actions éducatives (2013-2019) dans des lycées et collèges français.',
        ...
        'publications-description': '60 publications et actes de conférence.<br><br>Consultez ma liste complète de publications sur <a href="https://scholar.google.com/citations?user=rxk_H-oAAAAJ" target="_blank" rel="noopener noreferrer">Google Scholar</a> ou <a href="https://www.researchgate.net/profile/Etienne-Loire" target="_blank" rel="noopener noreferrer">ResearchGate</a>.',
    ...
    vi: {
        ...
        'university-teaching-description': 'Trợ giảng (2006-2009, Sorbonne) giảng dạy toán học và khoa học máy tính.<br><br>Giảng viên khách mời về Dịch tễ học tại Đại học Kasetsart (2019-2022, Bangkok) cho sinh viên quốc tế.<br><br>Huấn luyện viên phân tích dữ liệu di truyền cho các đối tác quốc tế.',
        'research-title': 'Nhà Nghiên Cứu Khoa Học (2009-2025)',
        'research-description': 'Nhà nghiên cứu tại CIRAD (2015-2025) dẫn dắt các dự án về gen vi sinh vật, sinh học tiến hóa và kháng kháng sinh.<br><br>Nghiên cứu sau tiến sĩ tại CNRS và Viện Max Planck (2009-2015).<br><br>Tác giả của 60 công bố, được trích dẫn hơn 2500 lần.',
        'tutoring-title': 'Giáo Dục Trung Học & Dạy Kèm',
        'tutoring-description': 'Gia sư riêng môn AP Biology tại Trường Quốc tế Anh Hà Nội (2025).<br><br>Diễn giả tiếp cận trường học (2013-2019) thực hiện các buổi khoa học hấp dẫn tại các trường trung học Pháp.',
        ...
        'publications-description': '60 công bố và kỷ yếu hội nghị.<br><br>Xem danh sách công bố đầy đủ trên <a href="https://scholar.google.com/citations?user=rxk_H-oAAAAJ" target="_blank" rel="noopener noreferrer">Google Scholar</a> hoặc <a href="https://www.researchgate.net/profile/Etienne-Loire" target="_blank" rel="noopener noreferrer">ResearchGate</a>.',
